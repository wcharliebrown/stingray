	...
	pages := []models.Page{
		{
			...
			Navigation:     `<a href="/">Home</a> | <a href="/page/about">About</a> | <a href="/user/login">Login</a> | <a href="/config">Config</a>`,
			...
			Sidebar:        `<h3>Quick Links</h3><ul><li><a href="/page/about">About</a></li><li><a href="/page/demo">Demo</a></li><li><a href="/user/login">Login</a></li><li><a href="/metadata/tables">Database Tables</a></li><li><a href="/config">Config</a></li></ul>`,
		...
		{
			Slug:           "config",
			Title:          "Configuration Settings - Sting Ray",
			MetaDescription: "View and manage system configuration settings (admin/engineer only)",
			Header:         "Configuration Settings",
			Navigation:     `<a href="/">Home</a> | <a href="/page/about">About</a> | <a href="/metadata/tables">Database Tables</a> | <a href="/config">Config</a> | <a href="/user/logout">Logout</a>`,
			MainContent:    `<h2>Configuration Settings</h2><p>This page allows admin and engineer users to view system configuration. Sensitive values are masked.</p><div><a href='/'>&larr; Back to Home</a></div>`,
			Sidebar:        `<h3>Config Links</h3><ul><li><a href="/">Home</a></li><li><a href="/metadata/tables">Database Tables</a></li></ul>`,
			Footer:         "© 2025 StingRay",
			CSSClass:       "modern",
			Scripts:        "",
			Template:       "modern",
